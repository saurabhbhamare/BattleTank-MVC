...
public class TankSpawner : MonoBehaviour
{
    ...
    public void CreateTank(TankTypes tankType)
    {
        if(tankType == TankTypes.blue)
        {
            ...
            TankController tankController = new TankController(tankModel, tankView,tankList[0].bulletSpawner);
        }
        else if(tankType == TankTypes.green)
        {
            ...
            TankController tankController = new TankController(tankModel, tankView,tankList[1].bulletSpawner);
        }
        else if(tankType == TankTypes.red)
        {
            ...
            TankController tankController = new TankController(tankModel, tankView,tankList[2].bulletSpawner);
        }
